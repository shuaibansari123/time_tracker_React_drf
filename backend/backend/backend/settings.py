...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',  # Ensure CorsMiddleware is placed above this
]
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY_CLINT_ID = os.getenv('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY_CLINT_ID')
...
# If you want to allow cookies to be included in cross-site HTTP requests
